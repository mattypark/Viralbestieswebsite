  ...
  return (
    <main className="relative mx-auto w-full max-w-2xl px-6 py-10 md:py-16 flex flex-col gap-10">
      ...
      <Reveal delay={170} className="w-full">
        <div className="rounded-xl border border-pink-brand/40 bg-pink-brand/[0.07] p-4 space-y-3">
          ...
          <a
            ...
            className="group inline-flex w-full items-center justify-center gap-2 rounded-xl py-3 px-5 bg-[#25D366] hover:bg-[#1ebe57] text-white font-semibold tracking-wide shadow-[0_0_20px_rgba(37,211,102,0.4)] hover:shadow-[0_0_30px_rgba(37,211,102,0.6)] transition-all"
          >
            <MessageCircle size={18} className="text-white" strokeWidth={2.5} fill="white" />
