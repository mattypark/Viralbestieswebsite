      ...
      <Reveal delay={660} className="w-full">
        <div className="w-full space-y-6">
          <div className="text-center space-y-2">
            ...
            <h3 className="font-serif text-3xl md:text-4xl text-white max-w-lg mx-auto leading-tight">
              Your journey from <span className="italic text-neutral-400">watching</span> to{" "}
          ...
          <div className="flex flex-col gap-3">
              ...
              <div className="rounded-2xl bg-gradient-to-br from-pink-950/50 via-black to-black p-5 flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="font-serif text-lg md:text-xl text-white">Waitlist</span>
                ...
                <div className="shrink-0 text-right">
                  <div className="font-serif text-lg md:text-xl text-pink-brand font-bold">FREE</div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-neutral-800 bg-neutral-950/40 p-5 flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="font-serif text-lg md:text-xl text-white">VIP Training Access</div>
                <p className="text-xs md:text-sm text-neutral-400 mt-0.5">
                  Event replay, priority Q&amp;A, brand builder starter pack
                </p>
              </div>
              <div className="shrink-0 text-right">
                <div className="font-serif text-lg md:text-xl text-white font-bold">$27</div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-pink-brand/30 bg-gradient-to-br from-pink-950/30 via-black to-black p-5 flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-wrap items-center gap-2">
                  <span className="font-serif text-lg md:text-xl text-white">Power Weekend</span>
              ...
              <div className="shrink-0 text-right">
                <div className="font-serif text-lg md:text-xl text-white font-bold">$222</div>
              </div>
            </div>
              ...
              <div className="rounded-2xl bg-gradient-to-br from-pink-950/70 via-black to-black p-5 flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs md:text-sm text-neutral-300 mt-0.5">
                    30 days of live coaching, daily lessons, community, and audits
                  </p>
                </div>
                <div className="shrink-0 text-right">
                  <div className="font-serif text-lg md:text-xl text-pink-brand font-bold">$555</div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-neutral-800 bg-neutral-950/40 p-5 flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="font-serif text-lg md:text-xl text-white">Viral Besties Membership</div>
                <p className="text-xs md:text-sm text-neutral-400 mt-0.5">
                  Ongoing coaching, community, and continued growth after the challenge
                </p>
              </div>
              <div className="shrink-0 text-right">
          ...
          <p className="text-center text-xs text-neutral-500 max-w-md mx-auto">
            Every tier is optional. Start on the free waitlist and choose what&apos;s right
            for you when the beta opens.
          </p>
        </div>
      </Reveal>
